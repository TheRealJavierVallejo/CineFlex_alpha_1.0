...
import { LayoutGrid, Clapperboard, Users, Settings, ChevronLeft, ChevronRight, ScrollText } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1 p-2">
        ...
        <NavItem target={ViewState.SCRIPT} icon={ScrollText} label="Script" />
